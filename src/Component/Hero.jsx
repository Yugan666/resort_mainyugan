    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3  px-[10px] md:px-[100px] gap-4 mb-12 ">
                <img src={imgOne} alt="gallery-imgs" className='object-contain sticky top-14 md:top-0 -z-20 ' data-aos='fade-up' data-aos-delay='600' />
                <img src={imgTwo} alt="gallery-imgs" className='object-contain sticky top-14 md:top-0 -z-10' data-aos='fade-down' data-aos-delay='600' />
